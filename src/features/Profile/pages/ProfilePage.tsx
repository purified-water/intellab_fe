...
export const ProfilePage = () => {
  return (
    <div className="flex flex-col items-start justify-between min-h-screen pt-10 bg-gray-300 lg:flex-row">
      <div className="flex flex-col items-start p-4 sm:p-10 w-full lg:w-[470px] h-auto lg:h-[1100px] mb-10 lg:mb-20 bg-white rounded-[10px]">
        ...
        <div className="w-full my-4 border-t-2 border-gray-300 lg:my-10"></div>
