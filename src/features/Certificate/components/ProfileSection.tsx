...
export function ProfileSection(props: ProfileSectionProps) {
  ...
  if (loading) {
    content = (
      <div className="flex items-center text-white text-xl font-bold bg-gray5 p-4 rounded-lg space-x-2">
    ...
    content = (
      <div className="flex items-center text-white text-xl font-bold bg-gradient-to-r from-appPrimary to-appSecondary p-4 rounded-lg space-x-2">
        ...
        <div className="mb-4 space-y-1">
          <p className="text-2xl">Completed by {certificate?.username}</p>
