...
export const Header = (props: HeaderProps) => {
  ...
  const renderButton = () => {
    ...
    return (
      <button
        className="px-4 py-2 text-base font-bold text-black bg-white rounded-lg w-28 hover:bg-gray-300 mt-6 "
        style={{ width: width }}
        onClick={onClick}
      >
        {buttonText}
  ...
  return (
    <div className="p-4 text-white bg-gradient-to-r from-appPrimary to-appSecondary rounded-lg flex flex-col gap-3 mx-24 my-6 px-7">
