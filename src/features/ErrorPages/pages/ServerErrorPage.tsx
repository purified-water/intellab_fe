export function ServerErrorPage() {
  return (
    <div data-testid="error-page-container" className="flex flex-col items-center justify-center w-full h-screen">
      <svg
        data-testid="error-illustration"
        className="w-1/2 text-appPrimary md:w-1/3 lg:w-1/4"
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <p className="mt-4 text-gray-500 md:text-lg xl:text-xl">Whoops, something went wrong on our servers.</p>
      </div>
    </div>
  );
}
