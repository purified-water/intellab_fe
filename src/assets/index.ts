// aiOrbs
export { default as aiOrbLogo } from "./aiOrbs/ai_orb_logo.png";
export { default as lightAiOrbAnimation } from "./aiOrbs/light_ai_orb.mp4";

// Logos
export { default as intellabBottomLogo } from "./logos/intellab_bottom.svg";
